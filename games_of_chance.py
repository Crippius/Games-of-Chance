...
def enter_the_casino(initial_money=100):
    global money

    money = initial_money
    print("Welcome to the 'Games of Chance' casino! you have " + str(money) + " chips you can bet. Good Luck!")
    return initial_money

def exit_the_casino(initial_money=100):
    global money

    if money >= 100: 
        text = " (" + str(initial_money-100) + " more than what you had at the start)"
    else:
        text = " (" + str(initial_money-100) + " less than what you had at the start)"

    print("Thanks for coming to our casino! your balance is " + str(money) + text)
    return money
